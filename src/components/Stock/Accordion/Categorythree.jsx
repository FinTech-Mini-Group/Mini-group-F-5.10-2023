...
function Categorthree() {
  ...
  return (
    <>
    <div className=''>
        <h1 className='flex items-center text-TitleBold mb-[50px]' onClick={()=>toggleAccordion(0)}>Название категории 3 <span className='ml-[10px]'>{icons.bottom}</span></h1>
