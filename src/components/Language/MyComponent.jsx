  ...
  return (
   ...
   {(isOpen &&
    <div className=' absolute top-30 right-[-157px] bg-black p-2 rounded-[8px] pb-6'>
      ...
      <p onClick={() => changeLanguage('uz')} src={uzb} className='text-white text-Bodystrik flex items-center mb-3 gap-3 cursor-pointer'><img className='w-8'  src={uzb} alt="" />UZBEK</p>
