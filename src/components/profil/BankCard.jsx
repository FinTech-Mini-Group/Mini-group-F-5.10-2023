    ...
    <div className='fixed  z-500 inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center '>
        <div className='bg-[#FFFFFF] p-[30px] rounded-[10px]'>
                ...
                <div className='w-[480px] h-[380px] px-4 flex gap-8 items-start justify-center flex-col shadow-[0px_0px_20px_1px_rgba(0,0,0,0.10)] '>
                  <input onChange={handleChange}   maxLength={19} className='bg-[#EFEFF4] p-3 w-full flex justify-center' type="text" id="cardNumber" name="cardNumber" value={cardNumber} placeholder='5 5 6 7    7 8 4 4    3 3 4 4    6 7 8 9' />
                  <div className='flex items-center'>
                    <form className='flex items-center' onSubmit={handleSubmit} action="">
                      <label htmlFor="">
                  <input onChange={handleMonthChange} value={month} className='py-[22px] pr-[33px] pl-[22px] rounded-[5px] bg-[#EFEFF4] w-[110px]' type="text" placeholder='M M'/>
                  </label>
