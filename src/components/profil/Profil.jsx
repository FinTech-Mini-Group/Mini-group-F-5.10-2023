  ...
  return (
    <div className='m-[100px]'>
        <div className='flex gap-8 justify-between'>
            <div className='p-6 border border-change rounded-md w-[600px] '>
            ...
            <div className='bg-Crect p-6 border-change rounded-md w-[600px]'>
        ...
        <div className='flex justify-between mt-9'>
          <div className=' bg-button p-3 rounded-md px-10 py-2 w-[400px] flex flex-col gap-2 ' >
            <p className='text-subtitle'>Мои карты</p>
            <p className='text-brand'>Добавить карту</p>
          </div>
          <div className='border border-change rounded-md px-10 py-2 w-[400px] flex flex-col gap-2'>
