  ...
  return (
    <div className='Products'>
      ...
      >
        ...
        {
          productes && productes.map((element, value) =>
            <SwiperSlide>
              <div className='p-[20px] rounded-[5px] bg-[#FAFAFA] cursor-pointer ' key={value} >
                <img onClick={() => navigate(`/${element.path}`)} className='w-full' src={`${BASE_URL}${element?.image_urls[0]}`} alt="" />
                ...
                <p className='mb-[10px] text-Body text-Cback'>{element.title}</p>
