...
function Oplaty() {
  return (
    <div>
        ...
        <div className='py-4 pl-8 pr-8 flex items-center border-2 border-solid rounded-[5px] lg:w-[360px]'>
        <input className='w-6 h-6' type="radio"  />
        <h1 className='text-Bodybold ml-[10px]'>Оплата через Payme</h1>
        </div>
        <div className='py-4 pl-8 flex items-center border-2 border-solid rounded-[5px] lg:w-[360px]'>
        <input className='w-6 h-6' type="radio"   />
