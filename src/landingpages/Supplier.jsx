  ...
  return (
    <div className='lg:flex justify-center items-center mb-[50px] bg-Crect rounded-[10px]'>
        ...
        <div>
             ...
             <p className=' text-subtitless text-subtitles text-center lg:text-subtitle lg:text-subtitles mb-[40px] lg:text-start'>Продавайте свои товары и продукты удобно и <br/> легко на нашей оптовой платформе.</p>
