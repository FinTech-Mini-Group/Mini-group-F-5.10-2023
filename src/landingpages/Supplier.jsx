...
function Supplier() {
  return (
    <div className='lg:flex items-center  lg:mx-[100px] mb-[50px] bg-Crect rounded-[10px]'>
        ...
        <div>
             ...
             <p className=' text-subtitle text-subtitle text-center lg:text-subtitle lg:text-subtitle mb-[40px] lg:text-start'>Продавайте свои товары и продукты удобно и <br/> легко на нашей оптовой платформе.</p>
