                        ...
                        products.map((element, value) =>
                            <div className='p-[20px] rounded-[5px] bg-[#FAFAFA] '>
                                ...
                                <div className=' my-[10px]'>
                                    <button className='py-[5px] px-[8px] rounded-[4px] bg-Cbadge text-white mr-[10px]'>{element.discount}</button>
                                    <button className='py-[5px] px-[8px] rounded-[4px] bg-bgblue text-white'>Супер цена</button>
                                </div>
                                <p className='mb-[30px]  text-Body text-Cback'>{element.name} </p>
